...
import { Schedule } from './components/CALENDAR/schedule/schedule-component';

function App() {
  const { openModifyModal } = useContext(AvailabilityContext);
  const { openModifyUiData, isModification, isOpenRecordContract, isScheduleOpen } = openModifyModal;
    ...
    <div className='App'>
      <Routes>
        <Route path={`/`} element={<Navigation />}>
          ...
          <Route path={`/calendar`} element={<MainCalendarComponent />} />
